...
import { <%= name %>Entity } from 'src/<%= h.inflection.transform(name, ['pluralize', 'underscore', 'dasherize']) %>/entities/repository/<%= h.inflection.transform(name, ['underscore', 'dasherize']) %>.entity';
