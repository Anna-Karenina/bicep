...
import { DeepPartial } from 'src/_utils/types/deep-partial.type';
...
export class UsersService {
  ...
  async create(createProfileDto: ExtendedCreateUserDto): Promise<User> {
    const clonedPayload = {
  ...
  async update(
    ...
    const clonedPayload = { ...payload } as User;
